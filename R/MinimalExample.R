...
#' Version: 1.0.0
#' 
#' Generated: 2024-04-27T08:45:08.779593241
#'
#' @details
	#' The class is annotated with an @RClass to identify it as part of the
	#'   R API.
#' @export
MinimalExample = R6::R6Class("MinimalExample", public=list(
	...
	#' @description 
	#' demo: 
	#' Documentation of the method can be done in JavaDoc and these will be
	#'   present in the R documentation
	...
	#' minExample$demo(dataframe=tibble::tibble(input=c(1,2,3)),
	#'   message='Hello world')
