...
.onLoad <- function(libname, pkgname) {
	...
	jarLoc = paste0(libpath,"/java/r6-generator-docs-main-SNAPSHOT-jar-with-dependencies.jar")
	
	if (!file.exists(jarLoc)) {
		
		jarLoc = paste0(libpath,"/inst/java/r6-generator-docs-main-SNAPSHOT-jar-with-dependencies.jar")
		...
		if (!file.exists(jarLoc)) {
			...
			fs::file_copy(jarLoc, paste0(libpath,"/java/r6-generator-docs-main-SNAPSHOT-jar-with-dependencies.jar"))
		}
	}
