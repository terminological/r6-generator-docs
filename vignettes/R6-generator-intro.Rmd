...
here::i_am("vignettes/R6-generator-intro.Rmd")
...
codeSnip("java",filename=here::here("../src/main/java/uk/co/terminological/rjava/test/MinimalExample.java"))
```



```{r results='asis',echo=FALSE}
codeSnipByLine(type="xml",filename=here::here("../pom.xml"),
...
```{r out.width="100%"}
knitr::include_graphics(here::here("vignettes/screenshots.png"))
```
