...
uml = readr::read_file(here::here("java/target/generated-docs/RTypes.txt"))
...
invisible(plot(p,file = here::here("docs/articles/RTypes.svg")))
knitr::include_graphics(here::here("docs/articles/RTypes.svg" ))
```
