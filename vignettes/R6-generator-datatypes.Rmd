...
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_01",endMatches = "SECTION_02")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_02",endMatches = "SECTION_03")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_03",endMatches = "SECTION_04")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_04",endMatches = "SECTION_05")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_05",endMatches = "SECTION_06")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_06",endMatches = "SECTION_07")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_07",endMatches = "SECTION_08")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_08",endMatches = "SECTION_09")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/BounceTest.java"),startMatches = "SECTION_09",endMatches = "SECTION_10")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FactoryTest.java"),"SECTION_01","SECTION_02")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FactoryTest.java"),"SECTION_02","SECTION_03")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FactoryTest.java"),"SECTION_03","SECTION_04")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FactoryTest.java"),"SECTION_04","SECTION_05")
```
