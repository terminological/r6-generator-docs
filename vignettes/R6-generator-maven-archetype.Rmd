...
# don't try evaluate this vignette 
# for snapshot versions except in interactive sessions (where locally installed snapshot is likely)
# this is because snapshot repository is not available for archetype downloads 
if (version == "main-SNAPSHOT") knitr::opts_chunk$set(eval = interactive())
version
```
