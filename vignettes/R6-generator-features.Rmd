...
#stop(getwd())
#stop(rprojroot::find_root(rprojroot::is_git_root))
...
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FeatureTest.java"),"START_SNIP_1","END_SNIP_1") #,35,51)
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FeatureTest.java"),"START_SNIP_2","END_SNIP_2")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FeatureTest.java"),"START_SNIP_5","END_SNIP_5")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FeatureTest.java"),"START_SNIP_3","END_SNIP_3")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/FeatureTest.java"),"START_SNIP_4","END_SNIP_4")
```
This java code from refers to another class - `MoreFeatureTest` which has the following basic structure:

```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/MoreFeatureTest.java"),"START_SNIP_1","END_SNIP_1")
```
...
```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/MoreFeatureTest.java"),"START_SNIP_2","END_SNIP_2")
```
...
This can happen much later, and any errors thrown by the finaliser code
...
```{r results='asis', echo=FALSE}
codeSnip("java",
         filename=here::here("src/src/main/java/uk/co/terminological/rjava/test/Serialiser.java"),"SNIPPET_1","SNIPPET_2")
```
